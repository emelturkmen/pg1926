...
<div id="üst_banner">
 ...
 <li><a href="dunya.php">Dünya</a></li>
      <li><a style="background-color:#5887ff" href="ekonomi.php">Ekonomi</a></li>
...
<div class="fotorama" data-content-theme="b" data-max-width="100%" data-width="100%"   data-theme="y" >
 ...
 $listele3="select haber_id,haber_resim from tbl_haber where haber_kat_id=3 limit 2";
 ...
 <?php
   include("baglanti.php");
  $listele2="select haber_id,haber_resim,haber_baslik from tbl_haber where haber_kat_id=3 limit 3";
  ...
  <div id="haber">
   <?php
    include("baglanti.php");
	$listele="select haber_id,haber_resim,haber_baslik from tbl_haber where haber_kat_id=3";
