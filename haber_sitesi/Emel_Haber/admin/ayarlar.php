...
<div class="clearfix">
 ...
 error_reporting(0);
  ...
  <div class="duzenle"><!-- InstanceBeginEditable name="İçerik" --><b>Şifre Güncelle</b>
     
      <br />
   <form id="form1" name="form1" method="post" action="">
   <table width="100%" border="0" cellspacing="5" cellpadding="10">
  <tr>
    <td width="18%">Kullanıcı Adı</td>
    <td width="82%"><label for="textfield"></label>
      <input type="text" name="ad" id="textfield" /></td>
  </tr>
  <tr>
    <td>Yeni Şifre</td>
    <td><label for="textfield2"></label>
      <input type="text" name="sifre" id="textfield2" /></td>
  </tr>
  <tr>
    <td>Yeni Şifre Tekrar</td>
    <td><label for="textfield3"></label>
      <input type="text" name="sifre2" id="textfield3" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  $sifre = $_POST["sifre"];
  $sifre2 = $_POST["sifre2"];
  $guncelle = "update tbl_admin set sifre='".addslashes($sifre)."' where adi='".$ad."' ";
  $stat = $baglan->prepare($guncelle);
  $stat->execute();
  ?>
  <!-- InstanceEndEditable --></div>
