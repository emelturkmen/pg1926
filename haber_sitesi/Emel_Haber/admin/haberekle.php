...
<div class="clearfix">
 ...
 error_reporting(0);
  ...
  <div class="duzenle"><!-- InstanceBeginEditable name="İçerik" -->
    <p><b>Haber Ekle</b>      </p>
  ...
  <tr>
    ...
    <td width="82%">
      <input type="text" name="baslik" id="textfield" /></td>
      
  </tr>
  <tr>
    <td>Haber Resim Link</td>
    <td>
      <input type="text" name="resim" id="textfield2" /></td>
  </tr>
  <tr>
    <td>Haber İçerik</td>
    <td>
      <input type="text" name="icerik" id="textfield2" /></td>
  </tr>
   <tr>
    <td>Haber Kategori İD</td>
    <td>
      <input type="text" name="kategori" id="textfield2" /></td>
  </tr>
  <tr>
          <td></td>
...
include("../baglanti.php");
  ...
  $o = 1;
	   ...
	   $ekle = "insert into tbl_haber(haber_baslik,haber_resim,haber_icerik,haber_osayisi,haber_kat_id) values('$baslik','$resim','$icerik','$o','$kategori')";
	 $ekle2 = $baglan->prepare($ekle);
	 $ekle2->execute();
