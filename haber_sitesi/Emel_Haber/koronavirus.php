...
<title>Koronavirüs Haberleri</title>
...
<div class="fotorama" data-content-theme="b" data-max-width="100%" data-width="100%"   data-theme="y" >
 ...
 $listele3="select haber_id,haber_resim from tbl_haber where haber_kat_id=8 limit 2";
 ...
 ?>
  ...
  <?php
   include("baglanti.php");
  $listele2="select haber_id,haber_resim,haber_baslik from tbl_haber where haber_kat_id=8 limit 3";
  ...
  <?php
    include("baglanti.php");
	$listele="select haber_id,haber_resim,haber_baslik from tbl_haber where haber_kat_id=8";
